...
namespace Bookingcare_Winform.AdminContainer
{
    public partial class ManageBooking : Form
    {
        ...
        private void ManageBookingSchedule_Load(object sender, EventArgs e)
        {
        ...
        {
            if (this.cboDoctors.SelectedValue.ToString() == "")
            {
                MessageBox.Show("Bạn chưa chọn bạn sĩ!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
